...
describe('JenkinsClient', () => {
    ...
    it('build job', async () => {
        ...
        const client = new JenkinsClient('https://localhost:8080', 'user', 'pass', 'cert', 'key')
        await expect(client.build('jobs/foo/', {}))
            .resolves.toEqual('https://localhost:8080/queue/item/1234/')
    })
    ...
    it('get queue item job url', async () => {
        ...
        const client = new JenkinsClient('https://localhost:8080', 'user', 'pass', 'cert', 'key')
        await expect(client.getQueuedItemJobUrl('https://localhost:8080/queue/item/1234/'))
